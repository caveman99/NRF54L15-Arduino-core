...
- The bundled clean-derived example set is now compile-swept as a group: all 71 copied clean parity sketches build on `seeed:nrf54l15:xiao_nrf54l15`.
- Clean-core channel sounding examples are still not bundled here because the packaged Zephyr/NCS headers in this repo do not yet expose the required AUXDATA register definitions used by those sketches.
