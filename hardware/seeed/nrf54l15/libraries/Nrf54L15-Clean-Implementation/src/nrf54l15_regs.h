...
constexpr uint32_t GPIO_P0_BASE = static_cast<uint32_t>(NRF_P0_NS_BASE);
constexpr uint32_t GPIO_P1_BASE = static_cast<uint32_t>(NRF_P1_NS_BASE);
constexpr uint32_t GPIO_P2_BASE = static_cast<uint32_t>(NRF_P2_NS_BASE);
...
constexpr uint32_t I2S20_BASE = 0x400DD000UL;
...
#else
constexpr uint32_t GPIO_P0_BASE = static_cast<uint32_t>(NRF_P0_S_BASE);
constexpr uint32_t GPIO_P1_BASE = static_cast<uint32_t>(NRF_P1_S_BASE);
constexpr uint32_t GPIO_P2_BASE = static_cast<uint32_t>(NRF_P2_S_BASE);
...
constexpr uint32_t I2S20_BASE = 0x500DD000UL;
