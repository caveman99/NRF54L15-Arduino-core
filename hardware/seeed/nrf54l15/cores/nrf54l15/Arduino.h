 ...
 *
 * This header exposes Arduino-compatible APIs for the nRF54L15 core.
 *
 * Notes:
 * - This core uses a Zephyr/NCS-backed build/runtime pipeline.
 * - API breadth is kept aligned with the clean-core parity surface where practical.
 */
...
// Forward declaration for SysTick initialization (kept for API compatibility).
...
// Clock macros (fallback if core/tooling does not define F_CPU).
#ifndef F_CPU
